...
amputationModel_2DoF = '/../../../simhive/myo_sim/TP_Model/MyoLeg71_TP_2Motor.xml'
amputationModel_1DoF = '/../../../simhive/myo_sim/TP_Model/MyoLeg71_TP_1Motor.xml'
amputationModel_passive = '/../../../simhive/myo_sim/TP_Model/MyoLeg69_TF_PAssive.xml'
...
# Torso with prosthesis standing up
register_env_with_variants(id='myoAmp1DoFStand-v0',
        entry_point='myosuite.envs.myo.myobase.walk_v1:StandEnvV0',
        max_episode_steps=150,
        kwargs={
            'model_path' : curr_dir + amputationModel_1DoF,
            'normalize_act': True,
...
# Modified Amputee 2 DoF Walking ==============================
register_env_with_variants(id='myoAmp2DoFWalk-v0',
        entry_point='myosuite.envs.myo.myobase.walk_v1:WalkEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path' : curr_dir + amputationModel_2DoF,
            'normalize_act': True,
            'min_height':0.8,    # minimum center of mass height before reset
            'max_rot':0.8,       # maximum rotation before reset
            'hip_period':100,    # desired periodic hip angle movement
            'reset_type':'init', # none, init, random
            'target_x_vel':0.0,  # desired x velocity in m/s
            'target_y_vel':0.8,  # desired y velocity in m/s
            'target_rot': None   # if None then the initial root pos will be taken, otherwise provide quat
        }
    )

# Modified Amputee 1 DoF Walking ==============================
register_env_with_variants(id='myoAmp1DoFWalk-v0',
        entry_point='myosuite.envs.myo.myobase.walk_v1:WalkEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path' : curr_dir + amputationModel_1DoF,
...
# Modified Amputee Passive Walking ==============================
register_env_with_variants(id='myoAmpPassiveWalk-v0',
        entry_point='myosuite.envs.myo.myobase.PassiveWalk_V0:WalkEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path' : curr_dir + amputationModel_passive,
            'normalize_act': True,
            'min_height':0.8,    # minimum center of mass height before reset
            'max_rot':0.8,       # maximum rotation before reset
            'hip_period':100,    # desired periodic hip angle movement
...
# Modified Amputee Passive Stand ==============================
register_env_with_variants(id='myoAmpPassiveStand-v0',
        entry_point='myosuite.envs.myo.myobase.PassiveWalk_V0:StandEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path' : curr_dir + amputationModel_passive,
            'normalize_act': True,
...
# Test amputee walking per parts ===========================
register(id='myoChallengeAmputeeWalk-v0',
        entry_point='myosuite.envs.myo.myobase.amputeechallenge_v0:AmputeeChallengeV0',
        ...
        kwargs={
            ...
            'rough_range': (0, 0),
            'relief_range': (0, 0),
            #'stairs_range': (0.07, 0.35),
        }
    )

register(id='myoChallengeAmputeeWalk-v1',
        entry_point='myosuite.envs.myo.myobase.amputeechallenge_v0:ChaseAmputeeEnvV0',
        max_episode_steps=2000,
        kwargs={
            'model_path': curr_dir+amputationModel_1DoF,
            'normalize_act': True,
