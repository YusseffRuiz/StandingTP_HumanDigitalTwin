...
class WalkEnvV0(BaseV0):
    # Model is not walking
    #Track movement of the knees.
    DEFAULT_OBS_KEYS = [
        "qpos_without_xy",
        "qvel",
        "com_vel",
    ...
    def _get_feet_heights(self):
        ...
        """
        foot_id_l = self.sim.model.body_name2id("l_foot")
...
class StandEnvV0(BaseV0):
    ...
    def _get_foot_contact(self):
        ...
        if foot_contact[0] > threshold and foot_contact[2] > threshold:  # 0 -> l_foot, 1 -> toes, 2 -> prosthetic foot
